  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        <h1 style={{ margin: '0 0 20px 0', fontSize: '1.25rem', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '-0.5px' }}>Дэшборд Здоровья МТС</h1>
        
        <div style={{ marginBottom: '24px' }}>
          <h3 style={{ margin: '0 0 12px 0', fontSize: '0.8rem', textTransform: 'uppercase', letterSpacing: '1px', color: 'var(--mts-dark-gray)', fontWeight: '600' }}>Легенда</h3>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
            ...
            <span style={{ fontSize: '0.9rem', fontWeight: '500' }}>Здоров (≥ 80)</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
            ...
            <span style={{ fontSize: '0.9rem', fontWeight: '500' }}>Внимание (40 - 79)</span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <span style={{ fontSize: '0.9rem', fontWeight: '500' }}>Критично (0 - 39)</span>
          </div>
        </div>
          ...
          {hoveredNode ? (
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <div style={{ fontSize: '0.9rem', color: 'var(--mts-dark-gray)', fontWeight: '600', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Показатель Здоровья</div>
              </div>
            </div>
          ) : (
